...
const MAPS = [
  ...
  { key:'silithus', name:'希利苏斯', icon:'🐛', faction:'中立', lvlRange:[55,60],
    ...
    boss:{ name:'鲁卡安', emoji:'👁️', lvl:62, desc:'希利苏斯的禁忌之眼',
      ...
      skills:[{name:"暗影凝视",icon:"👁️",desc:"5倍暗影伤害",type:"dmg",mul:5,castTime:2},{name:"精神鞭笞",icon:"🌀",desc:"6倍伤害+减速",type:"dmg",mul:6,slow:true,castTime:3}] } },
  { key:'eastern_plague', name:'东瘟疫之地', icon:'☠️', faction:'中立', lvlRange:[55,60],
    ...
    boss:{ name:'克尔苏加德的密使', emoji:'🦴', lvl:62, desc:'天灾军团特使',
      passive:{critChance:0.2,dmgReduction:0.1},
      skills:[{name:"寒冰箭",icon:"❄️",desc:"5倍冰霜伤害+减速",type:"dmg",mul:5,slow:true,castTime:2},{name:"死亡凋零",icon:"💀",desc:"6倍AOE暗影伤害",type:"dmg",mul:6,castTime:3}] } },
  { key:'hellfire', name:'地狱火半岛', icon:'😈', faction:'外域', lvlRange:[58,63],
    ...
    boss:{ name:'玛瑟里顿', emoji:'😈', lvl:65, desc:'被囚禁的暗影议会成员',
      passive:{atkBonus:0.25,critChance:0.2,dmgReduction:0.1},
      skills:[{name:"地狱火",icon:"😈",desc:"6倍火焰伤害+灼烧",type:"dmg",mul:6,dot:true,castTime:2.5},{name:"暗影之怒",icon:"💢",desc:"7倍暗影伤害",type:"dmg",mul:7,castTime:3.5}] } },
  { key:'nagrand', name:'纳格兰', icon:'🦬', faction:'外域', lvlRange:[64,68],
    ...
    boss:{ name:'邦多', emoji:'👹', lvl:70, desc:'纳格兰食人魔之王',
      passive:{atkBonus:0.2,dmgReduction:0.15},
      skills:[{name:"粉碎打击",icon:"🔨",desc:"5倍伤害",type:"dmg",mul:5,castTime:2},{name:"狂暴冲锋",icon:"👹",desc:"6倍伤害",type:"dmg",mul:6,castTime:3}] } },
  { key:'shadowmoon', name:'影月谷', icon:'🌑', faction:'外域', lvlRange:[67,70],
    ...
    boss:{ name:'伊利丹·怒风', emoji:'😈', lvl:72, desc:'背叛者',
      passive:{dodgeChance:0.25,critChance:0.25,dmgReduction:0.1},
      skills:[{name:"埃辛诺斯之刃",icon:"🗡️",desc:"7倍伤害",type:"dmg",mul:7,castTime:2},{name:"恶魔变形",icon:"😈",desc:"8倍AOE暗影伤害",type:"dmg",mul:8,castTime:4}] } },
  { key:'borean', name:'北风苔原', icon:'❄️', faction:'诺森德', lvlRange:[68,72],
    ...
    boss:{ name:'卡格瓦', emoji:'🐊', lvl:74, desc:'神秘的鳄鱼之神',
      passive:{dodgeChance:0.15,dmgReduction:0.15},
      skills:[{name:"死亡翻滚",icon:"🐊",desc:"6倍伤害",type:"dmg",mul:6,castTime:2},{name:"鳄鱼之怒",icon:"💢",desc:"7倍伤害+吸血20%",type:"dmg",mul:7,lifeSteal:0.2,castTime:3}] } },
  { key:'storm', name:'风暴峭壁', icon:'⚡', faction:'诺森德', lvlRange:[76,80],
    ...
    boss:{ name:'索林姆', emoji:'⚡', lvl:82, desc:'雷电之王',
      passive:{critChance:0.3,dmgReduction:0.15},
      skills:[{name:"雷霆之怒",icon:"⚡",desc:"7倍自然伤害",type:"dmg",mul:7,castTime:2.5},{name:"闪电风暴",icon:"🌩️",desc:"8倍AOE伤害",type:"dmg",mul:8,castTime:4}] } },
