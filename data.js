  ...
  warrior: {
    ...
    trees:[
      {key:'arms', name:'武器', icon:'⚔️', masteryDesc:'致死打击伤害 +2%/精通', talents:[
        {key:'致命武器_9afo', name:'致命武器', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'破甲_9crt', name:'破甲', desc:'攻击 +4%/层 · 斩杀加成 +3%/层', max:3, mod:{atkPct:4,executeBonus:3}},
        ...
        {key:'致命势头_rhev', name:'致命势头', desc:'攻击 +6%/层 · 斩杀加成 +4%/层', max:3, req:22, mod:{atkPct:6,executeBonus:4}},
        ...
        {key:'无尽之怒_kl3i', name:'无尽之怒', desc:'攻击 +7%/层 · 攻速 +4%/层', max:5, req:30, mod:{atkPct:7,spdPct:4}},
        {key:'破甲专精_fqbq', name:'破甲专精', desc:'额外攻击 +3%/层 · 技能CD +4%/层', max:3, req:33, mod:{extraAtk:3,cdReduction:4}},
        {key:'致命专注_szok', name:'致命专注', desc:'暴伤 +12%/层 · 精通 +3%/层', max:3, req:36, mod:{critdPct:12,mastery:3}}
      ,
{key:'tal_3cuo6h', name:'千钧之力', desc:'攻击 +8%/层 · 力量 +6%/层', max:5,req:38,mod:{atkPct:8,strPct:6}},{key:'tal_h0awm3', name:'武器大师', desc:'额外攻击 +5%/层 · 技能CD +5%/层', max:5,req:42,mod:{extraAtk:5,cdReduction:5}},{key:'tal_yq7lc3', name:'战神', desc:'攻击 +12%/层 · 斩杀加成 +8%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,executeBonus:8,mastery:4}}]},
      {key:'fury', name:'狂暴', icon:'🔥', masteryDesc:'嗜血吸血效果 +4%/精通', talents:[
        ...
        {key:'狂战士_n468', name:'狂战士', desc:'攻击 +4%/层 · 暴击 +1%/层', max:5, mod:{atkPct:4,crit:1}},
        ...
        {key:'泰坦之握_k9fr', name:'泰坦之握', desc:'攻击 +8%/层', max:5, req:15, mod:{atkPct:8}},
        ...
        {key:'狂怒_w0x9', name:'狂怒', desc:'攻击 +6%/层 · 暴伤 +5%/层', max:5, req:25, mod:{atkPct:6,critdPct:5}},
        ...
        {key:'狂暴之力_glx9', name:'狂暴之力', desc:'额外攻击 +4%/层 · 攻速 +5%/层', max:3, req:33, mod:{extraAtk:4,spdPct:5}},
        {key:'狂战士之魂_8my2', name:'狂战士之魂', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_b6kj2z', name:'无尽狂怒', desc:'攻速 +8%/层 · 攻击 +5%/层', max:5,req:38,mod:{spdPct:8,atkPct:5}},{key:'tal_maxzem', name:'狂战', desc:'吸血 +5%/层 · 暴击 +3%/层', max:5,req:42,mod:{leech:5,crit:3}},{key:'tal_en9kr4', name:'战神', desc:'攻击 +12%/层 · 额外攻击 +6%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,extraAtk:6,mastery:4}}]},
      {key:'prot', name:'防护', icon:'🛡️', masteryDesc:'盾墙减伤效果 +3%/精通', talents:[
        ...
        {key:'防护宗师_k7w0', name:'防护宗师', desc:'生命 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{hpPct:10,mastery:3}}
      ,
{key:'tal_pomgzm', name:'铜墙铁壁', desc:'防御 +8%/层 · 生命 +5%/层', max:5,req:38,mod:{defPct:8,hpPct:5}},{key:'tal_7f5oiq', name:'坚不可摧', desc:'耐力 +8%/层 · 反伤 +5%/层', max:5,req:42,mod:{staPct:8,reflectDmg:5}},{key:'tal_ikwcqv', name:'战神', desc:'生命 +12%/层 · 全能 +6%/层 · 精通 +4%/层', max:3,req:45,mod:{hpPct:12,vers:6,mastery:4}},
{key:'tal_b0z1v9', name:'壁垒', desc:'防御 +8%/层 · 生命 +5%/层', max:5,req:38,mod:{defPct:8,hpPct:5}},{key:'tal_tjz4f9', name:'审判之盾', desc:'反伤 +6%/层 · 耐力 +6%/层', max:5,req:42,mod:{reflectDmg:6,staPct:6}},{key:'tal_05he3a', name:'守护天使', desc:'防御 +12%/层 · 生命 +8%/层 · 精通 +4%/层', max:3,req:45,mod:{defPct:12,hpPct:8,mastery:4}}]},
    ],
  },
  ...
  mage: {
    ...
    trees:[
      {key:'arcane', name:'奥术', icon:'✨', masteryDesc:'暴风雪伤害 +3%/精通', talents:[
        ...
        {key:'奥术强化_2ldc', name:'奥术强化', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'奥术涌动_vju1', name:'奥术涌动', desc:'攻击 +8%/层 · 技能CD +3%/层', max:5, req:15, mod:{atkPct:8,cdReduction:3}},
        ...
        {key:'法力专家_bk0b', name:'法力专家', desc:'减耗 +5%/层 · 攻击 +5%/层', max:5, req:28, mod:{costReduction:5,atkPct:5}},
        {key:'奥术之力_25md', name:'奥术之力', desc:'攻击 +7%/层 · 暴伤 +8%/层', max:5, req:30, mod:{atkPct:7,critdPct:8}},
        {key:'灵风_qnj3', name:'灵风', desc:'攻速 +6%/层 · 减耗 +4%/层', max:3, req:33, mod:{spdPct:6,costReduction:4}},
        {key:'奥术宗师_dh7l', name:'奥术宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_vy68we', name:'奥术洪流', desc:'攻击 +8%/层 · 减耗 +5%/层', max:5,req:38,mod:{atkPct:8,costReduction:5}},{key:'tal_uw6vj0', name:'法力风暴', desc:'智力 +8%/层 · 技能CD +5%/层', max:5,req:42,mod:{intPct:8,cdReduction:5}},{key:'tal_ytx7oz', name:'大法师', desc:'攻击 +12%/层 · 暴伤 +10%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,critdPct:10,mastery:4}}]},
      {key:'fire', name:'火焰', icon:'🔥', masteryDesc:'火球术灼烧伤害 +4%/精通', talents:[
        {key:'引燃_xwmm', name:'引燃', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'燃烧_ddyk', name:'燃烧', desc:'攻击 +8%/层', max:5, req:15, mod:{atkPct:8}},
        ...
        {key:'灼热_4nud', name:'灼热', desc:'攻击 +6%/层 · 吸血 +2%/层', max:5, req:25, mod:{atkPct:6,leech:2}},
        {key:'焦灼_fslr', name:'焦灼', desc:'斩杀加成 +5%/层 · 暴伤 +7%/层', max:5, req:28, mod:{executeBonus:5,critdPct:7}},
        {key:'炎爆_m7ik', name:'炎爆', desc:'攻击 +7%/层 · 暴击 +2%/层', max:5, req:30, mod:{atkPct:7,crit:2}},
        {key:'火焰专精_qi3j', name:'火焰专精', desc:'持续伤害 +8%/层 · 额外攻击 +3%/层', max:3, req:33, mod:{dotBonus:8,extraAtk:3}},
        {key:'烈焰宗师_xjj4', name:'烈焰宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_9gb7zz', name:'活体炸弹', desc:'持续伤害 +8%/层 · 暴击 +2%/层', max:5,req:38,mod:{dotBonus:8,crit:2}},{key:'tal_fis9ti', name:'炼狱', desc:'攻击 +8%/层 · 斩杀加成 +5%/层', max:5,req:42,mod:{atkPct:8,executeBonus:5}},{key:'tal_29bm2f', name:'大法师', desc:'攻击 +12%/层 · 暴伤 +10%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,critdPct:10,mastery:4}}]},
      {key:'frost', name:'冰霜', icon:'❄️', masteryDesc:'寒冰箭减速效果 +5%/精通', talents:[
        ...
        {key:'冰霜之触_ui6r', name:'冰霜之触', desc:'攻击 +4%/层 · 攻速 +3%/层', max:5, mod:{atkPct:4,spdPct:3}},
        ...
        {key:'寒冬_nnx5', name:'寒冬', desc:'攻击 +6%/层 · 暴击 +1.5%/层', max:3, req:22, mod:{atkPct:6,crit:1.5}},
        {key:'冰霜之咬_xdgt', name:'冰霜之咬', desc:'技能CD +4%/层 · 暴伤 +6%/层', max:5, req:25, mod:{cdReduction:4,critdPct:6}},
        {key:'急冻_d4uy', name:'急冻', desc:'额外攻击 +3%/层 · 攻击 +5%/层', max:5, req:28, mod:{extraAtk:3,atkPct:5}},
        ...
        {key:'冰霜宗师_kkmw', name:'冰霜宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_4sxjog', name:'冰河时代', desc:'防御 +8%/层 · 全能 +4%/层', max:5,req:38,mod:{defPct:8,vers:4}},{key:'tal_4bba7s', name:'绝对零度', desc:'暴伤 +10%/层 · 额外攻击 +4%/层', max:5,req:42,mod:{critdPct:10,extraAtk:4}},{key:'tal_815u80', name:'大法师', desc:'攻击 +12%/层 · 暴击 +3%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,crit:3,mastery:4}}]},
    ],
  },
  ...
  priest: {
    ...
    trees:[
      {key:'discipline', name:'戒律', icon:'🕊️', masteryDesc:'真言术盾吸收量 +4%/精通', talents:[
        ...
        {key:'救赎_5a4x', name:'救赎', desc:'攻击 +8%/层', max:5, req:15, mod:{atkPct:8}},
        ...
        {key:'戒律之力_31no', name:'戒律之力', desc:'技能CD +5%/层 · 攻击 +5%/层', max:3, req:33, mod:{cdReduction:5,atkPct:5}},
        {key:'戒律师宗_0txl', name:'戒律师宗', desc:'治疗 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{healBonus:10,mastery:3}}
      ,
{key:'tal_6ur2ah', name:'圣光庇护', desc:'防御 +8%/层 · 治疗 +5%/层', max:5,req:38,mod:{defPct:8,healBonus:5}},{key:'tal_tgaqq3', name:'天使', desc:'精神 +8%/层 · 治疗 +7%/层', max:5,req:42,mod:{spiPct:8,healBonus:7}},{key:'tal_gtapc7', name:'大祭司', desc:'治疗 +15%/层 · 技能CD +5%/层 · 精通 +4%/层', max:3,req:45,mod:{healBonus:15,cdReduction:5,mastery:4}}]},
      {key:'holy', name:'神圣', icon:'✝️', masteryDesc:'治疗术回复量 +5%/精通', talents:[
        ...
        {key:'神圣宗师_33ld', name:'神圣宗师', desc:'治疗 +12%/层 · 精通 +3%/层', max:3, req:36, mod:{healBonus:12,mastery:3}}
      ,
{key:'tal_o3gedr', name:'神圣眷顾', desc:'治疗 +8%/层 · 生命 +5%/层', max:5,req:38,mod:{healBonus:8,hpPct:5}},{key:'tal_1nketb', name:'永恒之光', desc:'精神 +8%/层 · 回复 +3%/层', max:5,req:42,mod:{spiPct:8,regFlat:3}},{key:'tal_06hcy6', name:'大祭司', desc:'治疗 +15%/层 · 全能 +5%/层 · 精通 +4%/层', max:3,req:45,mod:{healBonus:15,vers:5,mastery:4}},
{key:'tal_xwcf0i', name:'圣光洗礼', desc:'治疗 +8%/层 · 精神 +5%/层', max:5,req:38,mod:{healBonus:8,spiPct:5}},{key:'tal_2pupt2', name:'黎明之光', desc:'生命 +8%/层 · 治疗 +7%/层', max:5,req:42,mod:{hpPct:8,healBonus:7}},{key:'tal_whu9yf', name:'圣光化身', desc:'治疗 +15%/层 · 技能CD +5%/层 · 精通 +4%/层', max:3,req:45,mod:{healBonus:15,cdReduction:5,mastery:4}}]},
      {key:'shadow', name:'暗影', icon:'🌑', masteryDesc:'心灵震爆伤害 +3%/精通', talents:[
        {key:'暗影成型_dje7', name:'暗影成型', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'虚空形态_18n3', name:'虚空形态', desc:'攻击 +8%/层', max:5, req:15, mod:{atkPct:8}},
        {key:'暗影魔_ylie', name:'暗影魔', desc:'攻击 +5%/层 · 吸血 +2%/层', max:5, req:18, mod:{atkPct:5,leech:2}},
        {key:'虚空回响_zsfh', name:'虚空回响', desc:'额外攻击 +3%/层 · 暴伤 +5%/层', max:3, req:22, mod:{extraAtk:3,critdPct:5}},
        {key:'疯狂_bowy', name:'疯狂', desc:'攻击 +6%/层 · 攻速 +3%/层', max:5, req:25, mod:{atkPct:6,spdPct:3}},
        {key:'暗影之痛_m7pe', name:'暗影之痛', desc:'持续伤害 +7%/层 · 斩杀加成 +4%/层', max:5, req:28, mod:{dotBonus:7,executeBonus:4}},
        {key:'天启_uank', name:'天启', desc:'攻击 +7%/层 · 暴击 +2%/层', max:5, req:30, mod:{atkPct:7,crit:2}},
        {key:'混沌_uaof', name:'混沌', desc:'技能CD +5%/层 · 持续伤害 +5%/层', max:3, req:33, mod:{cdReduction:5,dotBonus:5}},
        {key:'暗影宗师_zywn', name:'暗影宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_olt688', name:'暗影幻灵', desc:'持续伤害 +8%/层 · 吸血 +3%/层', max:5,req:38,mod:{dotBonus:8,leech:3}},{key:'tal_wcgwwu', name:'虚空', desc:'攻击 +8%/层 · 暴击 +3%/层', max:5,req:42,mod:{atkPct:8,crit:3}},{key:'tal_bf4hdm', name:'暗影祭司', desc:'攻击 +12%/层 · 斩杀加成 +8%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,executeBonus:8,mastery:4}}]},
    ],
  },
  ...
  rogue: {
    ...
    trees:[
      {key:'assassination', name:'刺杀', icon:'🐍', masteryDesc:'毒刃持续伤害 +4%/精通', talents:[
        ...
        {key:'谋杀_m3cw', name:'谋杀', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'放血_m5bp', name:'放血', desc:'攻击 +8%/层', max:5, req:15, mod:{atkPct:8}},
        ...
        {key:'刺客之道_6wkb', name:'刺客之道', desc:'斩杀加成 +5%/层 · 攻击 +4%/层', max:5, req:25, mod:{executeBonus:5,atkPct:4}},
        {key:'暗杀_42j5', name:'暗杀', desc:'暴伤 +10%/层 · 额外攻击 +2%/层', max:5, req:28, mod:{critdPct:10,extraAtk:2}},
        {key:'死亡标记_bu1r', name:'死亡标记', desc:'攻击 +7%/层 · 暴击 +2%/层', max:5, req:30, mod:{atkPct:7,crit:2}},
        {key:'毒药大师_jgpa', name:'毒药大师', desc:'持续伤害 +8%/层 · 技能CD +4%/层', max:3, req:33, mod:{dotBonus:8,cdReduction:4}},
        {key:'刺杀宗师_rwpy', name:'刺杀宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_4gq2h5', name:'致命毒液', desc:'持续伤害 +8%/层 · 吸血 +3%/层', max:5,req:38,mod:{dotBonus:8,leech:3}},{key:'tal_er31mp', name:'暗杀大师', desc:'暴伤 +12%/层 · 斩杀加成 +5%/层', max:5,req:42,mod:{critdPct:12,executeBonus:5}},{key:'tal_za0dpi', name:'影舞者', desc:'攻击 +12%/层 · 暴击 +3%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,crit:3,mastery:4}}]},
      {key:'combat', name:'战斗', icon:'⚔️', masteryDesc:'背刺伤害 +3%/精通', talents:[
        ...
        {key:'剑刃冲锋_ln9o', name:'剑刃冲锋', desc:'攻击 +6%/层 · 攻速 +4%/层', max:3, req:22, mod:{atkPct:6,spdPct:4}},
        {key:'战斗狂热_ypmy', name:'战斗狂热', desc:'攻击 +6%/层 · 吸血 +2%/层', max:5, req:25, mod:{atkPct:6,leech:2}},
        {key:'致命打击_nc4p', name:'致命打击', desc:'暴伤 +8%/层 · 额外攻击 +3%/层', max:5, req:28, mod:{critdPct:8,extraAtk:3}},
        {key:'杀戮_0rw8', name:'杀戮', desc:'攻击 +7%/层 · 攻速 +4%/层', max:5, req:30, mod:{atkPct:7,spdPct:4}},
        {key:'战斗精通_qy0g', name:'战斗精通', desc:'技能CD +5%/层 · 减耗 +5%/层', max:3, req:33, mod:{cdReduction:5,costReduction:5}},
        {key:'战斗宗师_z8hj', name:'战斗宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_8x4uoo', name:'利刃', desc:'额外攻击 +5%/层 · 攻速 +6%/层', max:5,req:38,mod:{extraAtk:5,spdPct:6}},{key:'tal_iki3mc', name:'战斗大师', desc:'攻击 +8%/层 · 暴伤 +8%/层', max:5,req:42,mod:{atkPct:8,critdPct:8}},{key:'tal_h7prev', name:'剑圣', desc:'攻击 +12%/层 · 技能CD +6%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,cdReduction:6,mastery:4}}]},
      {key:'subtlety', name:'敏锐', icon:'👤', masteryDesc:'影遁攻击加成 +5%/精通', talents:[
        ...
        {key:'暗夜之刃_de22', name:'暗夜之刃', desc:'攻击 +6%/层 · 敏捷 +4%/层', max:5, req:18, mod:{atkPct:6,agiPct:4}},
        {key:'深影_31zb', name:'深影', desc:'攻击 +6%/层 · 技能CD +3%/层', max:3, req:22, mod:{atkPct:6,cdReduction:3}},
        {key:'暗影步_hu73', name:'暗影步', desc:'攻速 +5%/层 · 额外攻击 +3%/层', max:5, req:25, mod:{spdPct:5,extraAtk:3}},
        {key:'暗影之击_zpfd', name:'暗影之击', desc:'攻击 +7%/层 · 暴伤 +6%/层', max:5, req:28, mod:{atkPct:7,critdPct:6}},
        {key:'黑暗_9tr5', name:'黑暗', desc:'攻击 +6%/层 · 暴击 +2%/层', max:5, req:30, mod:{atkPct:6,crit:2}},
        {key:'暗影大师_szx0', name:'暗影大师', desc:'斩杀加成 +6%/层 · 技能CD +4%/层', max:3, req:33, mod:{executeBonus:6,cdReduction:4}},
        {key:'敏锐宗师_r0wm', name:'敏锐宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_d22q05', name:'影刃', desc:'攻击 +8%/层 · 斩杀加成 +5%/层', max:5,req:38,mod:{atkPct:8,executeBonus:5}},{key:'tal_sxtqtx', name:'暗杀大师', desc:'额外攻击 +5%/层 · 暴伤 +8%/层', max:5,req:42,mod:{extraAtk:5,critdPct:8}},{key:'tal_u69oap', name:'影舞者', desc:'攻击 +12%/层 · 全能 +6%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,vers:6,mastery:4}}]},
    ],
  },
  ...
  hunter: {
    ...
    trees:[
      {key:'bm', name:'兽王', icon:'🦁', masteryDesc:'狂野怒火攻击加成 +5%/精通', talents:[
        {key:'野性精神_kuxe', name:'野性精神', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'兽王_mpa1', name:'兽王', desc:'攻击 +8%/层', max:5, req:15, mod:{atkPct:8}},
        {key:'兽群之力_elhz', name:'兽群之力', desc:'攻速 +6%/层 · 攻击 +3%/层', max:5, req:18, mod:{spdPct:6,atkPct:3}},
        {key:'野性呼唤_z4zm', name:'野性呼唤', desc:'技能CD +5%/层 · 攻击 +4%/层', max:3, req:22, mod:{cdReduction:5,atkPct:4}},
        {key:'兽群_ds5h', name:'兽群', desc:'攻击 +6%/层 · 吸血 +2%/层', max:5, req:25, mod:{atkPct:6,leech:2}},
        {key:'凶暴_1761', name:'凶暴', desc:'暴伤 +8%/层 · 额外攻击 +3%/层', max:5, req:28, mod:{critdPct:8,extraAtk:3}},
        {key:'兽王之力_lugl', name:'兽王之力', desc:'攻击 +7%/层 · 暴击 +1.5%/层', max:5, req:30, mod:{atkPct:7,crit:1.5}},
        {key:'野兽大师_e4rr', name:'野兽大师', desc:'技能CD +5%/层 · 斩杀加成 +4%/层', max:3, req:33, mod:{cdReduction:5,executeBonus:4}},
        {key:'兽王宗师_l5ob', name:'兽王宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_belq97', name:'兽群呼唤', desc:'攻击 +8%/层 · 额外攻击 +4%/层', max:5,req:38,mod:{atkPct:8,extraAtk:4}},{key:'tal_pr5je7', name:'万兽之王', desc:'敏捷 +8%/层 · 暴击 +3%/层', max:5,req:42,mod:{agiPct:8,crit:3}},{key:'tal_s5oa1w', name:'兽王至尊', desc:'攻击 +12%/层 · 吸血 +6%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,leech:6,mastery:4}}]},
      {key:'marks', name:'射击', icon:'🎯', masteryDesc:'瞄准射击暴伤 +6%/精通', talents:[
        ...
        {key:'穿透射击_19gc', name:'穿透射击', desc:'攻击 +6%/层', max:3, mod:{atkPct:6}},
        ...
        {key:'狙击_1tn3', name:'狙击', desc:'攻击 +6%/层 · 暴击 +1.5%/层', max:5, req:18, mod:{atkPct:6,crit:1.5}},
        {key:'专注_79lf', name:'专注', desc:'攻速 +5%/层 · 减耗 +5%/层', max:3, req:22, mod:{spdPct:5,costReduction:5}},
        {key:'精确_63eb', name:'精确', desc:'攻击 +6%/层 · 暴伤 +5%/层', max:5, req:25, mod:{atkPct:6,critdPct:5}},
        {key:'远距射击_6oex', name:'远距射击', desc:'攻击 +7%/层 · 斩杀加成 +4%/层', max:5, req:28, mod:{atkPct:7,executeBonus:4}},
        {key:'神射手_ekaa', name:'神射手', desc:'暴伤 +10%/层 · 技能CD +3%/层', max:5, req:30, mod:{critdPct:10,cdReduction:3}},
        {key:'射击大师_ws7s', name:'射击大师', desc:'额外攻击 +4%/层 · 暴击 +2%/层', max:3, req:33, mod:{extraAtk:4,crit:2}},
        {key:'射击宗师_rqg8', name:'射击宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_nz9rg3', name:'鹰眼', desc:'攻击 +8%/层 · 暴击 +2%/层', max:5,req:38,mod:{atkPct:8,crit:2}},{key:'tal_lz5es2', name:'神射手', desc:'暴伤 +12%/层 · 斩杀加成 +5%/层', max:5,req:42,mod:{critdPct:12,executeBonus:5}},{key:'tal_h72z0v', name:'箭神', desc:'攻击 +12%/层 · 额外攻击 +6%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,extraAtk:6,mastery:4}}]},
      {key:'survival', name:'生存', icon:'🪤', masteryDesc:'多重射击伤害 +3%/精通', talents:[
        ...
        {key:'野火_a47o', name:'野火', desc:'攻击 +5%/层 · 吸血 +2%/层', max:5, req:18, mod:{atkPct:5,leech:2}},
        ...
        {key:'猎手_cuzg', name:'猎手', desc:'攻击 +6%/层 · 斩杀加成 +4%/层', max:5, req:28, mod:{atkPct:6,executeBonus:4}},
        {key:'荒野_4uzv', name:'荒野', desc:'生命 +6%/层 · 攻击 +5%/层', max:5, req:30, mod:{hpPct:6,atkPct:5}},
        {key:'生存大师_kg8s', name:'生存大师', desc:'反伤 +4%/层 · 全能 +3%/层', max:3, req:33, mod:{reflectDmg:4,vers:3}},
        {key:'生存宗师_xi9p', name:'生存宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_5u8399', name:'荒野求生', desc:'生命 +8%/层 · 全能 +4%/层', max:5,req:38,mod:{hpPct:8,vers:4}},{key:'tal_20kiyb', name:'陷阱之王', desc:'攻击 +8%/层 · 反伤 +4%/层', max:5,req:42,mod:{atkPct:8,reflectDmg:4}},{key:'tal_yhyekb', name:'生存至尊', desc:'攻击 +12%/层 · 防御 +8%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,defPct:8,mastery:4}}]},
    ],
  },
  ...
  shaman: {
    ...
    trees:[
      {key:'element', name:'元素', icon:'⚡', masteryDesc:'闪电链伤害 +4%/精通', talents:[
        ...
        {key:'升腾_tp00', name:'升腾', desc:'攻击 +8%/层', max:5, req:15, mod:{atkPct:8}},
        {key:'风暴守护者_icnc', name:'风暴守护者', desc:'暴击 +1.5%/层 · 技能CD +3%/层', max:5, req:18, mod:{crit:1.5,cdReduction:3}},
        {key:'原始之力_14gr', name:'原始之力', desc:'攻击 +6%/层 · 智力 +3%/层', max:3, req:22, mod:{atkPct:6,intPct:3}},
        {key:'过载_64ei', name:'过载', desc:'攻击 +6%/层 · 暴伤 +5%/层', max:5, req:25, mod:{atkPct:6,critdPct:5}},
        {key:'闪电奔涌_4thr', name:'闪电奔涌', desc:'暴击 +2%/层 · 攻速 +4%/层', max:5, req:28, mod:{crit:2,spdPct:4}},
        {key:'元素之力_8obu', name:'元素之力', desc:'攻击 +7%/层 · 额外攻击 +3%/层', max:5, req:30, mod:{atkPct:7,extraAtk:3}},
        {key:'风暴_kx6t', name:'风暴', desc:'技能CD +5%/层 · 减耗 +5%/层', max:3, req:33, mod:{cdReduction:5,costReduction:5}},
        {key:'元素宗师_97ag', name:'元素宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_mo6x3r', name:'雷霆之怒', desc:'攻击 +8%/层 · 技能CD +5%/层', max:5,req:38,mod:{atkPct:8,cdReduction:5}},{key:'tal_z1lero', name:'元素掌控', desc:'暴伤 +12%/层 · 额外攻击 +4%/层', max:5,req:42,mod:{critdPct:12,extraAtk:4}},{key:'tal_2kpfcs', name:'元素领主', desc:'攻击 +12%/层 · 减耗 +8%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,costReduction:8,mastery:4}}]},
      {key:'enhancement', name:'增强', icon:'💨', masteryDesc:'风怒武器攻速加成 +6%/精通', talents:[
        {key:'武器专精_wx6r', name:'武器专精', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'漩涡之力_r509', name:'漩涡之力', desc:'攻击 +7%/层', max:5, req:15, mod:{atkPct:7}},
        {key:'风暴之怒_g93o', name:'风暴之怒', desc:'攻速 +5%/层 · 攻击 +3%/层', max:5, req:18, mod:{spdPct:5,atkPct:3}},
        {key:'闪电打击_j65p', name:'闪电打击', desc:'暴击 +2%/层 · 技能CD +3%/层', max:3, req:22, mod:{crit:2,cdReduction:3}},
        {key:'元素武器_bm2r', name:'元素武器', desc:'攻击 +6%/层 · 吸血 +2%/层', max:5, req:25, mod:{atkPct:6,leech:2}},
        {key:'风怒_ctkt', name:'风怒', desc:'攻速 +7%/层 · 额外攻击 +2%/层', max:5, req:28, mod:{spdPct:7,extraAtk:2}},
        {key:'漩涡_26cn', name:'漩涡', desc:'攻击 +7%/层 · 暴伤 +5%/层', max:5, req:30, mod:{atkPct:7,critdPct:5}},
        {key:'增强大师_8hsm', name:'增强大师', desc:'技能CD +5%/层 · 减耗 +4%/层', max:3, req:33, mod:{cdReduction:5,costReduction:4}},
        {key:'增强宗师_7xq2', name:'增强宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_r11ajl', name:'风暴', desc:'攻速 +8%/层 · 额外攻击 +4%/层', max:5,req:38,mod:{spdPct:8,extraAtk:4}},{key:'tal_8s2vb6', name:'狂怒风暴', desc:'攻击 +8%/层 · 暴击 +3%/层', max:5,req:42,mod:{atkPct:8,crit:3}},{key:'tal_hr0iny', name:'风暴领主', desc:'攻击 +12%/层 · 技能CD +6%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,cdReduction:6,mastery:4}}]},
      {key:'restoration', name:'恢复', icon:'🌊', masteryDesc:'治疗波回复量 +5%/精通', talents:[
        ...
        {key:'恢复宗师_fqhg', name:'恢复宗师', desc:'治疗 +12%/层 · 精通 +3%/层', max:3, req:36, mod:{healBonus:12,mastery:3}}
      ,
{key:'tal_qw36s6', name:'生命之泉', desc:'治疗 +8%/层 · 回复 +3%/层', max:5,req:38,mod:{healBonus:8,regFlat:3}},{key:'tal_sz1bbs', name:'先祖智慧', desc:'精神 +8%/层 · 治疗 +6%/层', max:5,req:42,mod:{spiPct:8,healBonus:6}},{key:'tal_sy9xob', name:'灵魂行者', desc:'治疗 +15%/层 · 全能 +5%/层 · 精通 +4%/层', max:3,req:45,mod:{healBonus:15,vers:5,mastery:4}}]},
    ],
  },
    ...
    trees:[
      {key:'holy', name:'神圣', icon:'✨', masteryDesc:'圣光术回复量 +5%/精通', talents:[
        ...
        {key:'beacon',      name:'圣光信标', desc:'生命 +8%/层', max:3, req:15, mod:{hpPct:8}},
	        ...
	        {key:'windfury2',name:'风暴之怒',desc:'攻速+6%/层,攻击+4%/层', max:3, req:22, mod:{spdPct:6,atkPct:4}},
      ]},
      ...
      {key:'ret', name:'惩戒', icon:'⚔️', masteryDesc:'十字军打击伤害 +3%/精通', talents:[
        {key:'复仇_vhng', name:'复仇', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'圣殿骑士_erj9', name:'圣殿骑士', desc:'攻击 +8%/层', max:5, req:15, mod:{atkPct:8}},
        {key:'神圣风暴_gg1s', name:'神圣风暴', desc:'攻击 +5%/层 · 攻速 +4%/层', max:5, req:18, mod:{atkPct:5,spdPct:4}},
        {key:'行刑者_49sa', name:'行刑者', desc:'斩杀加成 +5%/层 · 暴击 +1.5%/层', max:3, req:22, mod:{executeBonus:5,crit:1.5}},
        {key:'神圣之力_qr4h', name:'神圣之力', desc:'攻击 +6%/层 · 暴伤 +5%/层', max:5, req:25, mod:{atkPct:6,critdPct:5}},
        {key:'圣光之刃_3unr', name:'圣光之刃', desc:'攻击 +7%/层 · 暴击 +1.5%/层', max:5, req:28, mod:{atkPct:7,crit:1.5}},
        {key:'黎明_g4ek', name:'黎明', desc:'攻击 +6%/层 · 额外攻击 +3%/层', max:5, req:30, mod:{atkPct:6,extraAtk:3}},
        {key:'惩戒大师_psyh', name:'惩戒大师', desc:'技能CD +5%/层 · 斩杀加成 +4%/层', max:3, req:33, mod:{cdReduction:5,executeBonus:4}},
        {key:'惩戒宗师_c3xi', name:'惩戒宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_v97irx', name:'神圣复仇', desc:'攻击 +8%/层 · 暴伤 +6%/层', max:5,req:38,mod:{atkPct:8,critdPct:6}},{key:'tal_j4xnxx', name:'圣光之怒', desc:'额外攻击 +5%/层 · 斩杀加成 +5%/层', max:5,req:42,mod:{extraAtk:5,executeBonus:5}},{key:'tal_6df7gn', name:'复仇天使', desc:'攻击 +12%/层 · 暴击 +3%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,crit:3,mastery:4}}]},
    ],
  },
  ...
  warlock: {
    ...
    trees:[
      {key:'affliction', name:'痛苦', icon:'🧿', masteryDesc:'腐蚀术持续伤害 +5%/精通', talents:[
        {key:'苦痛_rf1z', name:'苦痛', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'痛苦无常_g3z5', name:'痛苦无常', desc:'攻击 +7%/层', max:5, req:15, mod:{atkPct:7}},
        ...
        {key:'苦痛_154n', name:'苦痛', desc:'攻击 +6%/层 · 持续伤害 +4%/层', max:5, req:25, mod:{atkPct:6,dotBonus:4}},
        {key:'瘟疫_j23m', name:'瘟疫', desc:'持续伤害 +7%/层 · 斩杀加成 +3%/层', max:5, req:28, mod:{dotBonus:7,executeBonus:3}},
        {key:'诅咒_p59u', name:'诅咒', desc:'攻击 +7%/层 · 暴击 +1.5%/层', max:5, req:30, mod:{atkPct:7,crit:1.5}},
        {key:'痛苦大师_xv69', name:'痛苦大师', desc:'持续伤害 +8%/层 · 吸血 +3%/层', max:3, req:33, mod:{dotBonus:8,leech:3}},
        {key:'痛苦宗师_06z2', name:'痛苦宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_10ra21', name:'无尽痛苦', desc:'持续伤害 +8%/层 · 吸血 +4%/层', max:5,req:38,mod:{dotBonus:8,leech:4}},{key:'tal_jix3v7', name:'灵魂凋零', desc:'攻击 +8%/层 · 斩杀加成 +5%/层', max:5,req:42,mod:{atkPct:8,executeBonus:5}},{key:'tal_980cwe', name:'痛苦之王', desc:'攻击 +12%/层 · 持续伤害 +10%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,dotBonus:10,mastery:4}}]},
      {key:'demonology', name:'恶魔学识', icon:'😈', masteryDesc:'生命分流吸血效果 +6%/精通', talents:[
        ...
        {key:'强化恶魔_lv28', name:'强化恶魔', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'恶魔变形_ao5c', name:'恶魔变形', desc:'攻击 +7%/层', max:5, req:15, mod:{atkPct:7}},
        {key:'小鬼成群_85l6', name:'小鬼成群', desc:'攻速 +4%/层 · 攻击 +3%/层', max:5, req:18, mod:{spdPct:4,atkPct:3}},
        {key:'灵魂链接_e01b', name:'灵魂链接', desc:'生命 +5%/层 · 吸血 +2%/层', max:3, req:22, mod:{hpPct:5,leech:2}},
        {key:'邪能领主_ko0x', name:'邪能领主', desc:'攻击 +6%/层 · 全能 +2%/层', max:5, req:25, mod:{atkPct:6,vers:2}},
        {key:'恶魔之力_93ih', name:'恶魔之力', desc:'攻击 +7%/层 · 吸血 +2%/层', max:5, req:28, mod:{atkPct:7,leech:2}},
        {key:'黑暗_da7r', name:'黑暗', desc:'生命 +6%/层 · 攻击 +5%/层', max:5, req:30, mod:{hpPct:6,atkPct:5}},
        {key:'恶魔大师_u7up', name:'恶魔大师', desc:'反伤 +4%/层 · 技能CD +3%/层', max:3, req:33, mod:{reflectDmg:4,cdReduction:3}},
        {key:'恶魔宗师_w3lg', name:'恶魔宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_ymsi4c', name:'恶魔军团', desc:'攻击 +8%/层 · 攻速 +5%/层', max:5,req:38,mod:{atkPct:8,spdPct:5}},{key:'tal_kt8luu', name:'邪能', desc:'生命 +8%/层 · 反伤 +5%/层', max:5,req:42,mod:{hpPct:8,reflectDmg:5}},{key:'tal_frgmc2', name:'恶魔之王', desc:'攻击 +12%/层 · 吸血 +6%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,leech:6,mastery:4}}]},
      {key:'destruction', name:'毁灭', icon:'🔥', masteryDesc:'烧尽伤害 +3%/精通', talents:[
        ...
        {key:'浩劫_t70a', name:'浩劫', desc:'攻击 +7%/层', max:5, req:15, mod:{atkPct:7}},
        {key:'毁灭烈焰_mf6z', name:'毁灭烈焰', desc:'暴伤 +8%/层 · 攻击 +3%/层', max:5, req:18, mod:{critdPct:8,atkPct:3}},
        {key:'大灾变_s7bc', name:'大灾变', desc:'攻击 +6%/层 · 减耗 +5%/层', max:3, req:22, mod:{atkPct:6,costReduction:5}},
        {key:'混沌_35iu', name:'混沌', desc:'暴伤 +8%/层 · 技能CD +3%/层', max:5, req:25, mod:{critdPct:8,cdReduction:3}},
        {key:'火雨_vd37', name:'火雨', desc:'攻击 +7%/层 · 额外攻击 +2%/层', max:5, req:28, mod:{atkPct:7,extraAtk:2}},
        {key:'末日_xdn3', name:'末日', desc:'攻击 +6%/层 · 斩杀加成 +5%/层', max:5, req:30, mod:{atkPct:6,executeBonus:5}},
        {key:'毁灭大师_hocz', name:'毁灭大师', desc:'技能CD +5%/层 · 暴击 +2%/层', max:3, req:33, mod:{cdReduction:5,crit:2}},
        {key:'毁灭宗师_g5ki', name:'毁灭宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_b7fe6p', name:'混沌之雨', desc:'攻击 +8%/层 · 暴伤 +6%/层', max:5,req:38,mod:{atkPct:8,critdPct:6}},{key:'tal_4qj3im', name:'末日降临', desc:'斩杀加成 +8%/层 · 技能CD +5%/层', max:5,req:42,mod:{executeBonus:8,cdReduction:5}},{key:'tal_hw275i', name:'毁灭之王', desc:'攻击 +12%/层 · 暴击 +4%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,crit:4,mastery:4}}]},
    ],
  },
  ...
  druid: {
    ...
    trees:[
      {key:'balance', name:'平衡', icon:'🌙', masteryDesc:'月火术持续伤害 +4%/精通', talents:[
        ...
        {key:'星辰坠落_4ilg', name:'星辰坠落', desc:'攻击 +7%/层', max:5, req:15, mod:{atkPct:7}},
        {key:'月火之雨_jaxm', name:'月火之雨', desc:'攻击 +5%/层 · 智力 +3%/层', max:5, req:18, mod:{atkPct:5,intPct:3}},
        {key:'天体_nrrx', name:'天体', desc:'攻击 +6%/层 · 技能CD +3%/层', max:3, req:22, mod:{atkPct:6,cdReduction:3}},
        {key:'自然之力_se1j', name:'自然之力', desc:'持续伤害 +6%/层 · 攻速 +3%/层', max:5, req:25, mod:{dotBonus:6,spdPct:3}},
        {key:'星辰_p1jw', name:'星辰', desc:'攻击 +7%/层 · 暴伤 +5%/层', max:5, req:28, mod:{atkPct:7,critdPct:5}},
        {key:'宇宙_l0zt', name:'宇宙', desc:'攻击 +6%/层 · 暴击 +2%/层', max:5, req:30, mod:{atkPct:6,crit:2}},
        {key:'平衡大师_jz5z', name:'平衡大师', desc:'技能CD +5%/层 · 持续伤害 +5%/层', max:3, req:33, mod:{cdReduction:5,dotBonus:5}},
        {key:'平衡宗师_kn9s', name:'平衡宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_bji6d5', name:'星辰之怒', desc:'攻击 +8%/层 · 持续伤害 +5%/层', max:5,req:38,mod:{atkPct:8,dotBonus:5}},{key:'tal_n2ivt5', name:'银河', desc:'智力 +8%/层 · 技能CD +5%/层', max:5,req:42,mod:{intPct:8,cdReduction:5}},{key:'tal_0ntb43', name:'星界行者', desc:'攻击 +12%/层 · 暴伤 +10%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,critdPct:10,mastery:4}}]},
      {key:'feral', name:'野性', icon:'🐺', masteryDesc:'凶猛撕咬伤害 +4%/精通', talents:[
        {key:'掠食者_kl5n', name:'掠食者', desc:'攻击 +5%/层', max:5, mod:{atkPct:5}},
        ...
        {key:'顶级掠食者_j56p', name:'顶级掠食者', desc:'攻击 +7%/层', max:5, req:15, mod:{atkPct:7}},
        {key:'兽群之王_7p9m', name:'兽群之王', desc:'暴击 +2%/层 · 攻速 +3%/层', max:5, req:18, mod:{crit:2,spdPct:3}},
        {key:'野性怒吼_6z8m', name:'野性怒吼', desc:'攻击 +5%/层 · 额外攻击 +3%/层', max:3, req:22, mod:{atkPct:5,extraAtk:3}},
        {key:'掠食本能_ezb2', name:'掠食本能', desc:'攻击 +6%/层 · 吸血 +2%/层', max:5, req:25, mod:{atkPct:6,leech:2}},
        {key:'撕咬_hpp3', name:'撕咬', desc:'攻击 +7%/层 · 斩杀加成 +4%/层', max:5, req:28, mod:{atkPct:7,executeBonus:4}},
        ...
        {key:'野性宗师_016z', name:'野性宗师', desc:'攻击 +10%/层 · 精通 +3%/层', max:3, req:36, mod:{atkPct:10,mastery:3}}
      ,
{key:'tal_dw1ibr', name:'掠食本能', desc:'攻击 +8%/层 · 吸血 +4%/层', max:5,req:38,mod:{atkPct:8,leech:4}},{key:'tal_cx76zw', name:'兽群之王', desc:'攻速 +8%/层 · 暴击 +3%/层', max:5,req:42,mod:{spdPct:8,crit:3}},{key:'tal_n4yxop', name:'荒野之王', desc:'攻击 +12%/层 · 斩杀加成 +8%/层 · 精通 +4%/层', max:3,req:45,mod:{atkPct:12,executeBonus:8,mastery:4}}]},
      {key:'resto', name:'恢复', icon:'🌿', masteryDesc:'回春术回复量 +5%/精通', talents:[
        ...
        {key:'恢复宗师_f473', name:'恢复宗师', desc:'治疗 +12%/层 · 精通 +3%/层', max:3, req:36, mod:{healBonus:12,mastery:3}}
      ,
{key:'tal_dq1zl9', name:'自然之愈', desc:'治疗 +8%/层 · 生命 +5%/层', max:5,req:38,mod:{healBonus:8,hpPct:5}},{key:'tal_gvfwv6', name:'永续', desc:'回复 +5%/层 · 精神 +6%/层', max:5,req:42,mod:{regFlat:5,spiPct:6}},{key:'tal_tsnlze', name:'自然之灵', desc:'治疗 +15%/层 · 技能CD +5%/层 · 精通 +4%/层', max:3,req:45,mod:{healBonus:15,cdReduction:5,mastery:4}}]},
    ],
  },
};
...
const ROLE_BONUS={
  ...
  dps:{atkPct:10, crit:3},
};
/* 羁绊:集齐 keys 中全部随从即激活,给主角额外加成 */
const COMPANION_BONDS=[
  {name:"守护者之力", keys:["medivh","jaina"],            mod:{atkPct:8,crit:4},   desc:"麦迪文 + 吉安娜"},
  {name:"燃烧军团",   keys:["kiljaeden","azshara"],       mod:{atkPct:8,critdPct:8},desc:"基尔加丹 + 艾萨拉"},
  {name:"天灾降临",   keys:["lichking","kelthuzad"],      mod:{atkPct:6,leech:6},  desc:"巫妖王 + 克尔苏加德"},
  {name:"怒风兄弟",   keys:["illidan","malfurion"],       mod:{atkPct:5,hpPct:5},  desc:"伊利丹 + 玛法里奥"},
  {name:"乌瑞恩王室", keys:["varian","anduin"],           mod:{hpPct:6,atkPct:4},  desc:"瓦里安 + 安度因"},
  {name:"大酋长之路", keys:["thrall","saurfang"],         mod:{atkPct:6,vers:4},   desc:"萨尔 + 萨鲁法尔"},
