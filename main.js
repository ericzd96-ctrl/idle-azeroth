...
function setupDelegation() {
  ...
  (() => {
    ...
    root.addEventListener('mouseover', e => {
      if (!hoverTipsEnabled()) return;
      const sk = e.target.closest('.comp-skill,.comp-bond-member[data-tip],.comp-bond-chip[data-tip],.comp-mission-roster-chip[data-tip],.comp-mission-best[data-tip],.comp-mission-send[data-tip],.comp-mission-score[data-tip]'); if (!sk) return;
